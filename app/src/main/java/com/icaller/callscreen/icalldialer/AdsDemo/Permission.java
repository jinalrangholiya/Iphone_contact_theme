...
public class Permission {
    public static boolean isStoragePermissionGranted(Context context) {
        return Build.VERSION.SDK_INT >= 33 ? context.checkSelfPermission("android.permission.READ_MEDIA_IMAGES") == 0 : context.checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") == 0 && context.checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0;
    }
