...
public class CallLogAdapter extends RecyclerView.Adapter<CallLogAdapter.ViewHolder> {
    ...
    public CallLogAdapter(List<CallLogDataItem> list, Context context) {
        this.callLogs = list;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (callLogItem.getCallType().equals("Outgoing")) {
            viewHolder.image.setBackgroundResource(R.drawable.outgoing);
        } else {
        ...
        viewHolder.info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!callLogItem.getName().equals("")) {
                    CallLogAdapter.this.openContactDetails(callLogItem.getName());
                } else {
                    Toast.makeText(CallLogAdapter.this.context, "No Details because Number not Save", 0).show();
                }
            }
        });
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override 
            public void onClick(View view) {
                CallLogAdapter.this.makeDirectCall(callLogItem.getNumber());
            }
        });
    }
